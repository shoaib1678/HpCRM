...
<body>
									...
									<table class="table table-hover table-striped nowrap" id="employee_table" style="width: 100%;">
										<thead class="bg-primary">
											<tr>
												...
												<th class="text-white">Available Position</th>
	...
	<script type="text/javascript">
		...
		function addrow() {
			...
			for(var i=2; i <= parseInt(total_position)+1; i++){
				var j= parseInt(i)-1
				html += '<tr id="rowss'+j+'">';
				html += '<td><input type="text" name="position'+i+'" class="form-control p-2" value='+j+'  id="position'+i+'" disabled/></td>';
				html += '<td><input type="text" name="position_amount'+ i+ '" class="form-control p-2"  id="position_amount'+ i+ '"/></td>';
				html += '</tr>';
			}
			$('#tbody').append(html);
		}
