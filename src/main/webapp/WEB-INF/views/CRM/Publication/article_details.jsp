			...
			$("#employee_table").DataTable({
				...
				}, 
				{
					"data" : function(data, type,
						...
						var string = "<button class='btn btn-primary btn-sm' type='button' onclick='edit(" + sno + ")' style='margin-bottom: 3px;'>Edit</button>";
                    	string += '<button type="button" class="btn btn-sm btn-success" onclick="Confirm(' + sno + ')" style="margin-bottom: 3px;">Send for Acceptance</button>';
