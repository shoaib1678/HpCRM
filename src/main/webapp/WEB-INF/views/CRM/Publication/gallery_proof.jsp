					...
					.validate(
							{
								...
								submitHandler : function(form) {
									...
									var obj = {
										"gallery_proof_date" : proof_date,
										"sno" : sno,
									};
									 $.ajax({
											url : 'add_gallery_proof',
											type : 'post',
			...
			$("#employee_table").DataTable({
				...
				}, 
				{
					"data" : function(data, type,
						...
						var string = "<button class='btn btn-success btn-sm' type='button' onclick='proofDate(" + sno + ")' style='margin-bottom: 3px;'>Add Gallery Proof Date</button>";
